...
const BookInfo = ({ book, onReviewClick }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
    <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">{book.title}</h1>
    <p className="text-xl italic mb-4 text-gray-700 dark:text-gray-300">{book.author}</p>
